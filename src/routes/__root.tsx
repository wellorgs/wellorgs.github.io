...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://assistyai.in/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Assisty AI logo: You can't answer every call. Assisty can." },
      { name: "twitter:image", content: "https://assistyai.in/og-image.png" },
