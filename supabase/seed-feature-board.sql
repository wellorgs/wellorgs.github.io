...
INSERT INTO public.feature_ideas (slug, title, detail, category, status, author, votes) VALUES
  ...
  ('transfer-the-live-call-to-me-2', 'Transfer the live call to me', 'If a caller says they need me personally, Assisty rings me and hands the call over without dropping it.', 'Calls', 'exploring', 'Assisty team', 0),
  ('spam-and-sales-call-filtering-3', 'Spam and sales call filtering', 'Recognise cold sales calls and spam, end them politely, and keep them out of my summaries.', 'Calls', 'exploring', 'Assisty team', 0),
  ...
  ('searchable-call-history-5', 'Searchable call history', 'Search past calls by name, number or what was said, and jump straight to the recording.', 'Summaries', 'exploring', 'Assisty team', 0),
  ...
  ('summaries-on-whatsapp-too-7', 'Summaries on WhatsApp too', 'A short WhatsApp message after each call, in addition to the app push notification.', 'Summaries', 'exploring', 'Assisty team', 0),
  ...
  ('more-regional-languages-and-dialects-10', 'More regional languages and dialects', 'Better handling of mixed speech like Hinglish, and the smaller regional languages my callers use.', 'Languages', 'exploring', 'Assisty team', 0),
